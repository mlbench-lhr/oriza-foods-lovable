...
const values = [
  {
    icon: Leaf,
    title: "Pure & Organic",
    description: "We believe in delivering 100% pure and organic rice without any chemicals or additives.",
  },
  {
    icon: Target,
    title: "Quality First",
    description: "Every batch is tested and graded to meet strict quality standards.",
  },
  {
    icon: Award,
    title: "Trusted Brand",
    description: "Trusted by households, restaurants, and caterers across Pakistan.",
  },
  {
    icon: Users,
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-muted-foreground text-lg leading-relaxed">
                We bring you authentic Pakistani rice straight from the fields of Hafizabad. From premium 
                varieties like 1121 Basmati, Super Basmati, and Kainat to everyday options like IRRI-6 
                and PK-386, every grain is naturally fragrant, hygienically milled, and perfect for daily meals.
              </p>
              <p className="text-muted-foreground text-lg leading-relaxed">
                Trusted by households, restaurants, and caterers across Pakistan, we deliver pure, long, 
                and flavorful rice in every bag.
              </p>

              <div className="grid sm:grid-cols-2 gap-4 pt-4">
                {["Growing With Pakistan", "Quality You Can Trust", "Premium Varieties", "Hygienic Processing"].map((item) => (
            ...
            >
              ...
              <div className="absolute -bottom-8 -left-8 bg-card border border-border p-6 rounded-2xl max-w-xs">
                ...
                <p className="text-foreground font-semibold">Years of Excellence</p>
                <p className="text-muted-foreground text-sm mt-1">Serving Pakistani households since 1999</p>
              </div>
            </motion.div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                To combine innovation with agriculture, bringing modern, efficient, and sustainable food 
                solutions that support farmers and deliver quality to consumers. Every step we take is 
                aimed at transforming the agricultural landscape for a better future.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                To build a smarter, technology-driven future for agriculture — delivering purity, quality, 
                and innovation in every product we offer. We envision a Pakistan where every kitchen 
                enjoys the finest quality rice.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="container-custom text-center">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg mb-8 max-w-2xl mx-auto">
              Contact us today to learn more about our products and how we can serve your needs.
            </p>
